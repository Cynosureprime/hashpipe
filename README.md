...
## John the Ripper output (`-J`)

hashpipe reads `hash:password` pairs and reports the type it can *recompute*. By default it
...
Regenerate against a **freshly built** John; a stale tree silently omits formats. The
generated header records the John version and commit it was built from.
